...
export const RECEIVE_PROFOLE_SUCCESS = 'RECEIVE_PROFOLE_SUCCESS';
...
export const INITIALIZE_NEW_MESSAGE = 'INITIALIZE_NEW_MESSAGE';
export const SET_NEW_MESSAGE = 'SET_NEW_MESSAGE';
export const ON_PRESENCE_CHANGED = 'ON_PRESENCE_CHANGED';
export const ON_MESSAGES = 'ON_MESSAGES';
export const TOGGLE_REDIRECT_CHAT = 'TOGGLE_REDIRECT_CHAT';
